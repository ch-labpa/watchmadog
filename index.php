  ...
  <div class="tm-main">
    ...
    <div class="container">
      <div class="tm-search-form-container">
        <form id="search" action="" method="GET" class="form-inline tm-search-form">
          <label for="pet-switch">Looking for</label>
          <div class="form-group switch">
            <p id="pet_s">Pets</p>
            <div class="custom-control custom-switch custom-switch-lg">
              <input type="checkbox" class="custom-control-input" id="mode" <?= (isset($_GET["type"]) && $_GET["type"] == 'petSitter' ? 'checked="checked"' : "")  ?>>
              <label class="custom-control-label" for="mode"></label>
            </div>
            <p id="sitter_s">Pet sitter</p>
          </div>
    ...
    <div class="container">
      <div style="margin-left: 0;" class="row main">
          ...
          <div id="filter">
            ...
            <form id="petsitterForm" method="post">
              <div id="petsitterFilter">
                ...
                <div>
                  <br>
                  <button class="btn btn-primary" id="petsitterSub" type="submit">Submit</button>
                </div>
              </div>
            </form>
          </div>
        ...
        <!-- 
          - Pass get parameter to the function (in this case "displayHalloWorld")
                  exaple-> http://localhost/watchmadog/?type=pets
                  exaple-> http://localhost/watchmadog/?type=petSitter
          - in the "displayHalloWorld" check for the variable value and make 2 different mysql calls with the switch-case operator
         -->
        <?php
        $petsResultArray = $home->displayResults();
        ?>
        <div class="col-9">
          <div class="media-boxes">
            <?php for ($i = 0; $i < count($petsResultArray); $i++) : ?>
              <div class="media">
                <img src="img/<?= $petsResultArray[$i]['pic_name']  ?>" alt="Image" class="mr-3" style='width:auto;height:140px;'>
                <div class="media-body tm-bg-gray">
                  <div class="tm-description-box">
                    <h5 class="tm-text-blue"><?= $petsResultArray[$i]['name'] ?></h5>
                    <p>I'm a: <?= $petsResultArray[$i]['pet_wanted'] ?></p>
                    <p>My size is: <?= $petsResultArray[$i]['pet_size'] ?></p>
                  </div>
                  <div class="tm-buy-box">
                    <span class="tm-bg-blue tm-text-white tm-buy">Hourly <br> rate</span>
                    <span class="tm-text-blue tm-price-tag">€<?= $petsResultArray[$i]['price'] ?></span>
                  </div>
                </div>
              </div>
            <?php endfor; ?>
