    ...
    <div class="h-25 tm-welcome-section">
          ...
          <div class="col-12">
            <nav class="navbar navbar-expand-sm">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  <a href="login.html" class="nav-link tm-nav-link tm-text-white">SignIn</a>
                </li>
                <li class="nav-item">
                  <a href="contact.html" class="nav-link tm-nav-link tm-text-white">SignUp</a>
                </li>
              </ul>
            </nav>
          </div>
      ...
      <div class="container text-center tm-welcome-container">
        <div class="tm-welcome">
          ...
          <h1 class="text-uppercase mb-3 tm-site-name">WatchMaDog</h1>
          <p class="tm-site-description">Whether you are willing to sitter some pets or you need someone to look after your furry babies, here you can find what you're looking for.</p>
        </div>
      </div>
      ...
      <div class="tm-search-form-container">
        <form id ="location" action="index.html" method="GET" class="form-inline tm-search-form">
            <div class="form-group tm-search-box">
              <input type="text" name="keyword" class="form-control tm-search-input" placeholder="Type your region...">
